...
// (admin, need-approval, setting-periode, share-cost) directly into the URL bar, redirecting
// before the page's API calls start 403-ing (backend enforcement via middleware/auth.js's
// requireRole was always solid — this is a client-side UX gap on top of that).
//
