...
// security boundary — real enforcement is server-side (backend's identity provider +
// per-route guards, e.g. `DinasAccessGuard`/`RolesGuard`, NOT the old `middleware/auth.js`).
//
