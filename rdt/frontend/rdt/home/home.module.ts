...
// by clicking a Dashboard card (REQ-RDT-NAV-03), not a sidebar item, matching ui-demo.html where
// it isn't one of the four VIEWS-with-own-nav-highlight either (see shell.component.ts's
